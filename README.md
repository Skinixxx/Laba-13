...
# Таминдаров Николай Евгеньевич группа 220032-11
## Лабораторная работа по методам и технологиям программирования №13
## Вариант 23: Система e-learning (Повышенный)
## Система управления кинотеатром. Описание области: Фильмы, сеансы, залы, билеты, бронирование
